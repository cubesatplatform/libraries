...
{
  int channel = analogWriteChannel(pin);
  Serial.println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
  // Make sure the pin was attached to a channel, if not do nothing
  if (channel != -1 && channel < 16)
  {
    ...
    Serial.print("  Levels: ");Serial.print(levels);
    Serial.print("  Duty: ");Serial.print(duty);
    Serial.print("  ValueMax: ");Serial.print(valueMax);Serial.print("   Value: ");Serial.println(value);
  }
